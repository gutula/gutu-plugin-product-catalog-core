...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Catalog Control Room"),
    React.createElement("p", null, "Products, variants, and policy defaults that the rest of the suite can compose safely."),
    React.createElement(
      "p",
      null,
