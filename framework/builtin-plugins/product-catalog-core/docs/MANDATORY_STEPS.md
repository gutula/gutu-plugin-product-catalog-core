# Product & Catalog Core Mandatory Steps

## Before shipping a change

1. Update the public contract docs in `README.md` and `DEVELOPER.md`.
2. Keep the nested docs under `framework/builtin-plugins/product-catalog-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `product-catalog-core` and the package import `@plugins/product-catalog-core`.
