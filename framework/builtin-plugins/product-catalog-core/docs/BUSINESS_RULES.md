# Product & Catalog Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `product-catalog-core` and its owned resource set.
...
- ERP parity references are tracked against: `Stock`, `Selling`, `Buying`, `Manufacturing`.
