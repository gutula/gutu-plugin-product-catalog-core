# Product & Catalog Core Agent Context
...
- Package root: `framework/builtin-plugins/product-catalog-core`
- Service layer: `framework/builtin-plugins/product-catalog-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/product-catalog-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/product-catalog-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/product-catalog-core/src/ui`

## Safe assumptions

- Use `product-catalog-core` as the stable plugin identifier and `@plugins/product-catalog-core` as the package import name.
