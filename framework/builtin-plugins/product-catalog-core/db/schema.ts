...
export const primaryRecordsTable = pgTable("product_catalog_core_primary_records", {
...
export const secondaryRecordsTable = pgTable("product_catalog_core_secondary_records", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),
...
export const exceptionRecordsTable = pgTable("product_catalog_core_exception_records", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),
  primaryRecordId: text("primary_record_id").notNull(),
