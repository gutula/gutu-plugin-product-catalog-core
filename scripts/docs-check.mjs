...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/product-catalog-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-product-catalog-core:");
...
console.log("Documentation check passed for gutu-plugin-product-catalog-core.");
